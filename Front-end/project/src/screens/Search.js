          ...
          <div className='searchContents'>
            ...
            <div className='beachCardSection'>
              ...
              { BeachData.map((beach) => {
                  ...
                  const jellyfishDouble = parseFloat(jellyfish).toFixed(5);
                  ...
                  const jellyfishLight = jellyfish === "" ? 4 : 0 <= jellyfishDouble && 15 > jellyfishDouble ? 1 : 15 <= jellyfishDouble && 50 > jellyfishDouble ? 2 : 3;

                  console.log(jellyfishLight);
